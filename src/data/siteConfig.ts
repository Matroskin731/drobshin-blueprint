...
export const defaultConfig: SiteConfig = {
  ...
  navigation: [
    ...
    { id: "recycling", title: "Переработка РТИ", path: "/recycling", visible: true },
  ...
  products: [
    {
      ...
      items: [
        ...
        { id: "crumb-1-2", name: "Крошка 1–2 мм", description: "Универсальная фракция для покрытий и плитки", visible: true },
        { id: "crumb-2-4", name: "Крошка 2–4 мм", description: "Крупная фракция для спортивных и детских площадок", visible: true },
        { id: "crumb-color", name: "Цветная SBR крошка", description: "Окрашенная крошка для декоративных покрытий", visible: true },
      ],
    },
    {
      id: "tiles",
  ...
  articles: [
    {
      ...
      content: "Резиновые покрытия обеспечивают амортизацию при падении, не скользят, устойчивы к погодным условиям. Наша продукция соответствует ГОСТ и обеспечивает максимальную безопасность.",
      date: "2025-01-15",
      visible: true,
    },
  ],
