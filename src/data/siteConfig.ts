  ...
  articles: [
    {
      ...
      content: "Резиновые покрытия обеспечивают амортизацию при падении, не скользят, устойчивы к погодным условиям. Продукция соответствует ТУ и обеспечивает максимальную безопасность.",
      date: "2025-01-15",
      visible: true,
    },
  ],
