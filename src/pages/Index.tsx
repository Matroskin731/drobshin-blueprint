...
function AnimatedStat({ num, suffix, format }: { num: number; suffix: string; format: boolean }) {
  ...
  return (
    <div ref={ref}>
      <p className="text-3xl lg:text-4xl font-extrabold leading-none text-[#2f7f33] bg-secondary-foreground">{display}{suffix}</p>
    </div>
  );
}
          ...
          <div className="section-container">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
              {[
                ...
                { icon: Shield, title: "Гарантия качества", desc: "Продукция соответствует ТУ" },
      ...
      {isBlockVisible("how-we-work") && (
        <section className="section-padding section-dark-alt">
          <div className="section-container">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
              {[
                { step: "1", title: "Заявка", desc: "Оставьте заявку на сайте или позвоните" },
                { step: "2", title: "Расчёт", desc: "Подберём продукцию и рассчитаем стоимость" },
                { step: "3", title: "Производство", desc: "Изготовим продукцию под ваш заказ" },
                { step: "4", title: "Доставка", desc: "Отгрузим и доставим в ваш регион" },
              ].map((item, i) => (
                <motion.div
                  key={i}
                  initial="hidden" whileInView="visible"
